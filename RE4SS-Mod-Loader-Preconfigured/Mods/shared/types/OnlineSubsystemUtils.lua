...
---@param IndicateProgress boolean
---@param UserTag int32
---@return UAchievementWriteCallbackProxy
function UAchievementWriteCallbackProxy:WriteAchievementProgressInt(WorldContextObject, PlayerController, AchievementName, StatName, CurrentProgress, MaxProgress, IndicateProgress, UserTag) end
---@param WorldContextObject UObject
---@param PlayerController APlayerController
---@param AchievementName FName
---@param Progress float
