...
---@field SecondaryActorTick FActorSecondaryTickFunction
...
function APawn:ReceiveRestarted(CurrentController) end
...
---@param bClearExistingEffects boolean
function APlayerController:SetDisableTriggerEffects(bDisabled, bClearExistingEffects) end
...
function APlayerController:GetAudioListenerPosition(OutLocation, OutFrontDir, OutRightDir) end
---@param NewFOV float
...
---@param side ETriggerEffectSide
---@param StartPosition uint8
---@param EndPosition uint8
---@param Strength uint8
function APlayerController:ControllerTriggerEffectWeapon(side, StartPosition, EndPosition, Strength) end
---@param side ETriggerEffectSide
---@param Position uint8
---@param Amplitude uint8
---@param Frequency uint8
function APlayerController:ControllerTriggerEffectVibration(side, Position, Amplitude, Frequency) end
---@param side ETriggerEffectSide
function APlayerController:ControllerTriggerEffectOff(side) end
---@param side ETriggerEffectSide
---@param Position uint8
---@param Strength uint8
function APlayerController:ControllerTriggerEffectFeedback(side, Position, Strength) end
---@param Key FKey
...
---@return uint8
function APlayerState:GetPing() end
...
---@class FActorComponentSecondaryTickFunction : FTickFunction
FActorComponentSecondaryTickFunction = {}
...
---@class FActorSecondaryTickFunction : FTickFunction
FActorSecondaryTickFunction = {}
...
---@field MovementBaseName FString
...
---@class FComponentUpdateData
FComponentUpdateData = {}
...
---@field VolumetricFogQuality int32
---@field LODQuality int32
---@field AmbientOcclusionQuality int32
...
---@field RayTracingReflectionQuality int32
---@field RayTracingShadowQuality int32
---@field bUIEffectsEnabled boolean
---@field bBloomEnabled boolean
---@field bMotionBlurEnabled boolean
---@field DepthOfField int32
---@field VRSMode EVRSMode
---@field DLSSMode EDLSSMode
---@field bDLSSFrameGen boolean
---@field DLSSSharpness float
---@field ReflexMode EReflexMode
---@field XeSSMode EXeSSMode
---@field FSRMode EFSRMode
---@field NISMode ENISMode
---@field AntiAliasingMethod int32
FGraphicsSettings = {}
...
---@class FHMQAggregateTickHandle
FHMQAggregateTickHandle = {}


---@class FHMQAggregateTickManagerFunction : FTickFunction
FHMQAggregateTickManagerFunction = {}
...
---@field Name FName
---@field AudioAbsorbtion125Hz float
---@field AudioAbsorbtion250Hz float
---@field AudioAbsorbtion500Hz float
---@field AudioAbsorbtion1kHz float
---@field AudioAbsorbtion2kHz float
---@field AudioAbsorbtion4kHz float
---@field AudioScatteringCoefficient float
...
---@class FScreenSettings
---@field bVSyncEnabled boolean
---@field bHDREnabled boolean
---@field bDynamicResolutionEnabled boolean
---@field DynamicResMinScreenPercentage float
---@field DynamicResFrametimeBudget float
---@field FrameRateLimit float
---@field ColorContrast float
---@field UIColorContrast float
...
---@field bAggregate boolean
---@field bAggregateRespectPrerequisites boolean
---@field AggregateTickHandler UClass
---@field AggregateClass UClass
---@field AggregateObject UObject
...
---@class FUIDuringPhysicsTickFunction : FTickFunction
FUIDuringPhysicsTickFunction = {}
...
---@field SecondaryComponentTick FActorComponentSecondaryTickFunction
...
---@field bDontAddAccelerationToLedgeMove boolean
---@field MaxGetLedgeMoveAttemptsPerSimulation int32
...
---@field LastFindFloorResult FFindFloorResult
---@field NumFramesBetweenFindFloorChecks int32
...
---@field bSimulatedTickDisabled boolean
...
---@param inCustomMode uint8
---@return boolean
function UCharacterMovementComponent:IsInMovementMode(inMovementMode, inCustomMode) end
---@return float
...
---@param NewValue float
function UDirectionalLightComponent:SetDistanceFieldShadowDistance(NewValue) end
---@param NewValue float
...
---@param SecondFogDensity float
---@param SecondFogHeightFalloff float
---@param SecondFogHeightOffset float
function UExponentialHeightFogComponent:SetSecondFogData(SecondFogDensity, SecondFogHeightFalloff, SecondFogHeightOffset) end
---@param value float
...
---@field DLSSModeChanged FGameUserSettingsDLSSModeChanged
---@field XeSSModeChanged FGameUserSettingsXeSSModeChanged
---@field bUseRaytracedAudio boolean
---@field bUseRaytracedShadows boolean
---@field bUseRaytracedReflections boolean
---@field DefaultGraphicsSettings FGraphicsSettings
---@field DefaultScreenSettings FScreenSettings
...
---@field LastConfirmedMonitorID FString
---@field Version uint32
---@field AudioQualityLevel int32
---@field LastConfirmedAudioQualityLevel int32
---@field FrameRateLimit float
---@field bSyncFrameRateLimitOnBoot boolean
---@field DynamicResMinScreenPercentage float
---@field DynamicResFrametimeBudget float
---@field ColorContrast float
---@field UIColorContrast float
---@field FilmGrain float
---@field AltFireIndicator boolean
---@field EmissiveIntensity float
---@field ScreenSpaceReflectionsEnabled boolean
---@field AntiAliasingMethod int32
---@field VRSMode EVRSMode
---@field ScreenOptimizationMethod EScreenOptimisation
---@field DLSSMode EDLSSMode
---@field DLSSSharpness float
---@field bDLSSFrameGen boolean
---@field ReflexMode EReflexMode
...
---@return boolean
function UGameUserSettings:SupportsVRS() end
---@return boolean
function UGameUserSettings:SupportsRaytracing() end
---@return boolean
function UGameUserSettings:SupportsNGXDLSS() end
---@return boolean
function UGameUserSettings:SupportsNGX() end
---@return boolean
function UGameUserSettings:SupportsIntelXeSS() end
---@return boolean
function UGameUserSettings:SupportsHDRDisplayOutput() end
---@return boolean
function UGameUserSettings:ShouldSyncFrameRateLimitOnBoot() end
---@param InMode EXeSSMode
function UGameUserSettings:SetXeSSMode(InMode) end
---@param bEnable boolean
function UGameUserSettings:SetVSyncEnabledCVar(bEnable) end
---@param bEnable boolean
function UGameUserSettings:SetVSyncEnabled(bEnable) end
---@param value int32
function UGameUserSettings:SetVolumetricFogQuality(value) end
---@param value int32
function UGameUserSettings:SetVisualEffectQuality(value) end
---@param value int32
function UGameUserSettings:SetViewDistanceQuality(value) end
---@param InVRSMode EVRSMode
function UGameUserSettings:SetVariableRateShadingMode(InVRSMode) end
---@param UltrawideVideoSettings EUltrawideVideoSettings
function UGameUserSettings:SetUltrawideVideoSettings(UltrawideVideoSettings) end
---@param InUltrawideHUDSettings EUltrawideHUDSettings
function UGameUserSettings:SetUltrawideHUDSettings(InUltrawideHUDSettings) end
---@param UltrawideCinematicVideoSettings EUltrawideVideoSettings
function UGameUserSettings:SetUltrawideCinematicVideoSettings(UltrawideCinematicVideoSettings) end
---@param UIContrast float
function UGameUserSettings:SetUIContrast(UIContrast) end
---@param value int32
function UGameUserSettings:SetTouristEffectsQuality(value) end
...
---@param bEnable boolean
function UGameUserSettings:SetScreenSpaceReflectionEnabled(bEnable) end
---@param resolution FIntPoint
function UGameUserSettings:SetScreenResolution(resolution) end
---@param Method EScreenOptimisation
function UGameUserSettings:SetScreenOptimizationMethod(Method) end
---@param NewScaleValue float
---@param bUseFixedMinResolutionScale boolean
function UGameUserSettings:SetResolutionScaleValueEx(NewScaleValue, bUseFixedMinResolutionScale) end
...
function UGameUserSettings:SetResolutionScaleNormalized(NewScaleNormalized, bInterpolate) end
---@param InMode EReflexMode
function UGameUserSettings:SetReflexMode(InMode) end
---@param value int32
function UGameUserSettings:SetReflectionQuality(value) end
---@param value int32
function UGameUserSettings:SetRayTracingShadowQuality(value) end
---@param value int32
function UGameUserSettings:SetRayTracingReflectionQuality(value) end
---@param bEnable boolean
function UGameUserSettings:SetRaytracedShadowsEnabled(bEnable) end
---@param bEnable boolean
function UGameUserSettings:SetRaytracedReflectionsEnabled(bEnable) end
---@param bEnable boolean
function UGameUserSettings:SetRaytracedAudioEnabled(bEnable) end
---@param Preset EQualityPreset
function UGameUserSettings:SetQualityPreset(Preset) end
---@param value int32
function UGameUserSettings:SetPostProcessingQuality(value) end
---@param InPerformanceHUDSettings EUltrawideHUDSettings
function UGameUserSettings:SetPerformanceHUDSettings(InPerformanceHUDSettings) end
---@param value int32
function UGameUserSettings:SetOverallScalabilityLevel(value) end
---@param InMode ENISMode
function UGameUserSettings:SetNISMode(InMode) end
---@param InMonitorID FString
function UGameUserSettings:SetMonitorID(InMonitorID) end
---@param value int32
function UGameUserSettings:SetLODQuality(value) end
---@param value int32
function UGameUserSettings:SetLightingQuality(value) end
---@param InSettings EQualitySettings
---@param InValue int32
function UGameUserSettings:SetGraphicsSettingsOverrides(InSettings, InValue) end
---@param InFullscreenMode EWindowMode::Type
function UGameUserSettings:SetFullscreenMode(InFullscreenMode) end
---@param InMode EFSRMode
function UGameUserSettings:SetFSRMode(InMode) end
...
---@param FilmGrain float
function UGameUserSettings:SetFilmGrainSettings(FilmGrain) end
---@param EmissiveIntensity float
function UGameUserSettings:SetEmissiveIntensity(EmissiveIntensity) end
---@param TargetFramerate float
function UGameUserSettings:SetDynamicResTargetFramerate(TargetFramerate) end
---@param bEnable boolean
function UGameUserSettings:SetDynamicResolutionEnabled(bEnable) end
---@param MinPercentage float
---@param bInterpolate boolean
function UGameUserSettings:SetDynamicResMinScreenPercentage(MinPercentage, bInterpolate) end
---@param InSharpness float
function UGameUserSettings:SetDLSSSharpness(InSharpness) end
---@param InMode EDLSSMode
function UGameUserSettings:SetDLSSMode(InMode) end
---@param InFrameGen boolean
function UGameUserSettings:SetDLSSFrameGen(InFrameGen) end
---@param value int32
function UGameUserSettings:SetDepthOfFieldQuality(value) end
---@param Contrast float
function UGameUserSettings:SetColorContrast(Contrast) end
...
---@param InAntiAliasingMethod EAntiAliasingMethod
function UGameUserSettings:SetAntiAliasingMethod(InAntiAliasingMethod) end
---@param value int32
function UGameUserSettings:SetAmbientOcclusionQuality(value) end
---@param AltFireIndicator boolean
function UGameUserSettings:SetAltFireIndicatorSettings(AltFireIndicator) end
...
function UGameUserSettings:RevertResolution() end
function UGameUserSettings:RevertFullscreenMode() end
function UGameUserSettings:ResetToCurrentSettings() end
---@param InResolutionX int32
---@param InResolutionY int32
---@param InWindowMode EWindowMode::Type
---@param bInDoOverrides boolean
function UGameUserSettings:RequestResolutionChangeWithAspectRatio(InResolutionX, InResolutionY, InWindowMode, bInDoOverrides) end
---@param DriverOutOfDate boolean
---@param MinDriverVersionMajor int32
---@param MinDriverVersionMinor int32
function UGameUserSettings:NGXDriverUpdateRequired(DriverOutOfDate, MinDriverVersionMajor, MinDriverVersionMinor) end
...
---@return boolean
function UGameUserSettings:IsVariableRateShadingModeDirty() end
---@return boolean
function UGameUserSettings:IsScreenResolutionDirty() end
---@return boolean
function UGameUserSettings:IsRaytracedShadowsEnabled() end
---@return boolean
function UGameUserSettings:IsRaytracedShadowsDirty() end
---@return boolean
function UGameUserSettings:IsRaytracedReflectionsEnabled() end
---@return boolean
function UGameUserSettings:IsRaytracedReflectionsDirty() end
---@return boolean
...
---@return boolean
function UGameUserSettings:IsAntiAliasingMethodDirty() end
---@return EXeSSMode
function UGameUserSettings:GetXeSSMode() end
---@return float
function UGameUserSettings:GetVsyncCappedFrameRateLimit() end
---@return int32
function UGameUserSettings:GetVolumetricFogQuality() end
---@return int32
function UGameUserSettings:GetVisualEffectQuality() end
---@return int32
function UGameUserSettings:GetViewDistanceQuality() end
---@return EVRSMode
function UGameUserSettings:GetVariableRateShadingMode() end
---@return boolean
function UGameUserSettings:GetUseHDDOptimizations() end
---@return EUltrawideVideoSettings
function UGameUserSettings:GetUltrawideVideoSettings() end
---@return EUltrawideHUDSettings
function UGameUserSettings:GetUltrawideHUDSettings() end
---@return EUltrawideVideoSettings
function UGameUserSettings:GetUltrawideCinematicVideoSettings() end
---@return float
function UGameUserSettings:GetUIContrastBoundsMin() end
---@return float
function UGameUserSettings:GetUIContrastBoundsMax() end
---@return float
function UGameUserSettings:GetUIContrast() end
---@return int32
function UGameUserSettings:GetTouristEffectsQuality() end
---@return int32
...
---@return boolean
function UGameUserSettings:GetScreenSpaceReflectionEnabled() end
---@return FIntPoint
...
---@return EReflexMode
function UGameUserSettings:GetReflexMode() end
---@return int32
function UGameUserSettings:GetReflectionQuality() end
---@return float
function UGameUserSettings:GetRecommendedResolutionScale() end
---@return int32
function UGameUserSettings:GetRayTracingShadowQuality() end
---@return int32
function UGameUserSettings:GetRayTracingReflectionQuality() end
---@return EQualityPreset
function UGameUserSettings:GetQualityPreset() end
...
---@return EUltrawideHUDSettings
function UGameUserSettings:GetPerformanceHUDSettings() end
---@return int32
function UGameUserSettings:GetOverallScalabilityLevel() end
---@return ENISMode
function UGameUserSettings:GetNISMode() end
---@return FString
function UGameUserSettings:GetMonitorID() end
---@return float
function UGameUserSettings:GetMinimumAllowedResolutionScale() end
---@return int32
function UGameUserSettings:GetLODQuality() end
---@return int32
function UGameUserSettings:GetLightingQuality() end
---@return FIntPoint
function UGameUserSettings:GetLastConfirmedScreenResolution() end
---@return FString
function UGameUserSettings:GetLastConfirmedMonitorID() end
---@return EWindowMode::Type
function UGameUserSettings:GetLastConfirmedFullscreenMode() end
---@return EScreenOptimisation
function UGameUserSettings:GetHardwareFavouredScreenOptimisation() end
---@param InSettings EQualitySettings
---@return int32
function UGameUserSettings:GetGraphicsSettingsOverrides(InSettings) end
...
---@return EFSRMode
function UGameUserSettings:GetFSRMode() end
---@return float
...
---@return float
function UGameUserSettings:GetFilmGrainSettings() end
---@return float
function UGameUserSettings:GetEmissiveIntensity() end
---@return float
function UGameUserSettings:GetDynamicResTargetFramerate() end
---@return float
function UGameUserSettings:GetDynamicResMinScreenPercentage() end
---@return float
function UGameUserSettings:GetDLSSSharpness() end
---@return EDLSSMode
function UGameUserSettings:GetDLSSMode() end
---@return boolean
function UGameUserSettings:GetDLSSFrameGen() end
---@return float
function UGameUserSettings:GetDisplayRefreshRate() end
---@return FIntPoint
function UGameUserSettings:GetDesktopResolution() end
---@return int32
function UGameUserSettings:GetDepthOfFieldQuality() end
---@return FIntPoint
...
---@return float
function UGameUserSettings:GetContrastBoundsMin() end
---@return float
function UGameUserSettings:GetContrastBoundsMax() end
---@return float
function UGameUserSettings:GetColorContrast() end
---@return float
function UGameUserSettings:GetCachedDisplayRefreshRate() end
---@return int32
...
function UGameUserSettings:GetAntiAliasingMethod() end
---@return int32
function UGameUserSettings:GetAmbientOcclusionQuality() end
---@return boolean
function UGameUserSettings:GetAltFireIndicatorSettings() end
---@param bEnable boolean
---@param DisplayNits int32
function UGameUserSettings:EnableHDRDisplayOutput(bEnable, DisplayNits) end
function UGameUserSettings:DisableSyncFrameRateLimitOnBoot() end
function UGameUserSettings:ConfirmVideoMode() end
function UGameUserSettings:ConfirmResolution() end
function UGameUserSettings:ConfirmFullsreenMode() end
---@param UIContrastValue float
function UGameUserSettings:ApplyUIContrast(UIContrastValue) end
...
---@param NewFullscreenMode EWindowMode::Type
function UGameUserSettings:ApplyPreferredFullscreenMode(NewFullscreenMode) end
function UGameUserSettings:ApplyPhotomodeSettings() end
...
---@class UHMQAggregateTickHandler : UObject
UHMQAggregateTickHandler = {}


---@class UHMQAggregateTickManager : UObject
---@field TickManagers TMap<UClass, UHMQAggregateTickHandler>
---@field OwningWorld UWorld
UHMQAggregateTickManager = {}



---@class UHMQSimpleActorAggregateTickHandler : UHMQAggregateTickHandler
UHMQSimpleActorAggregateTickHandler = {}


---@class UHMQSimpleComponentAggregateTickHandler : UHMQAggregateTickHandler
UHMQSimpleComponentAggregateTickHandler = {}
...
function UInputSettings:UpdateLayout() end
...
---@param KeyName FKey
---@param OutMappings TArray<FInputAxisKeyMapping>
function UInputSettings:GetAxisMappingByKey(KeyName, OutMappings) end
...
---@param KeyName FKey
---@param OutMappings TArray<FInputActionKeyMapping>
function UInputSettings:GetActionMappingByKey(KeyName, OutMappings) end
function UInputSettings:ForceRebuildKeymaps() end
---@param Key FKey
---@return FKey
function UInputSettings:ConvertKeyEnglishToCulture(Key) end
---@param Key FKey
---@return FKey
function UInputSettings:ConvertKeyCultureToEnglish(Key) end
function UInputSettings:ConvertAllKeysEnglishToCulture() end
function UInputSettings:ConvertAllKeysCultureToEnglish() end
---@param KeyMapping FInputAxisKeyMapping
---@param bForceRebuildKeymaps boolean
...
---@return boolean
function UKismetSystemLibrary:GetSupportedFullscreenResolutionsForDisplayDevice(Resolutions, DeviceName) end
---@param Resolutions TArray<FIntPoint>
---@return boolean
...
---@field AmortizedActorsToBeginPlay TArray<AActor>
ULevel = {}
...
---@field bIsRequestingUnloadAndRemoval boolean
---@field bShouldBeVisible boolean
---@field bShouldBeLoaded boolean
...
---@class ULevelStreamingNeverLODs : ULevelStreamingAlwaysLoaded
ULevelStreamingNeverLODs = {}
...
---@field bCastVolumetricShadowsWithRayTracing boolean
...
---@field bEnableMaterialSpecificShadingRate boolean
...
---@field bCastRayTracedShadowsWindows boolean
...
---@class UMaterialExpressionPlatformSwitch : UMaterialExpression
---@field Default FExpressionInput
---@field Inputs FExpressionInput
UMaterialExpressionPlatformSwitch = {}
...
---@param ParameterName FName
---@param ParameterValue FLinearColor
function UMeshComponent:SetVector4ParameterValueOnMaterials(ParameterName, ParameterValue) end
---@param ParameterName FName
---@param ParameterValue UTexture
function UMeshComponent:SetTextureParameterValueOnMaterials(ParameterName, ParameterValue) end
---@param ParameterName FName
---@param ParameterValue float
...
---@param Exponent float
function UPlayerInput:SetMouseExponent(Exponent) end
...
---@param Snapshot FPoseSnapshot
function UPoseableMeshComponent:SnapshotPose(Snapshot) end
---@param BoneName FName
---@param InTransform FTransform
...
---@field MinViewDistanceScale float
...
---@field bVisibleInRayTracingWindows boolean
...
---@field Brightness float
---@field bTGGISurfelCollector boolean
...
---@field RayTracingStaticLodBias uint32
---@field bRayTracingAllowRuntimeStaticMeshDataBuilding boolean
...
---@field bSupportRayTracing FPerPlatformBool
...
---@field bSupportRayTracing FPerPlatformBool
---@field bOverrideRayTracingLODBias boolean
---@field RayTracingLODBias int32
...
---@field AggregateTickManager UHMQAggregateTickManager
---@field PersistentLevel ULevel
---@field NetDriver UNetDriver
...
---@field AddedAsync_ComponentsThatNeedEndOfFrameUpdate TArray<FComponentUpdateData>
