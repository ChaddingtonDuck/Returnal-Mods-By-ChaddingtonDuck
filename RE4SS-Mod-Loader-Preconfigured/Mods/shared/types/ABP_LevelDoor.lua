...
---@class UABP_LevelDoor_C : UDoorAnimInstance
...
function UABP_LevelDoor_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UABP_LevelDoor_C:ExecuteUbergraph_ABP_LevelDoor(EntryPoint) end
