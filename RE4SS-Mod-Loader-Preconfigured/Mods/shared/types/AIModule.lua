...
---@param drawOnlyWhenSelected boolean
function AEQSTestingPawn:SetDrawOnlyWhenSelected(drawOnlyWhenSelected) end
function AEQSTestingPawn:RunEQSQuery() end
...
---@field bIgnoreLineTrace boolean
---@field LineOfSightCheckInterval float
...
---@field bUseMainTaskActiveKey boolean
---@field MainTaskActiveKey FBlackboardKeySelector
...
---@param Literal int32
---@return int32
function UBTFunctionLibrary:GetBlackboardValueOrLiteralAsInt(NodeOwner, Key, Literal) end
---@param NodeOwner UBTNode
---@param Key FBlackboardKeySelector
---@param Literal float
---@return float
function UBTFunctionLibrary:GetBlackboardValueOrLiteralAsFloat(NodeOwner, Key, Literal) end
---@param NodeOwner UBTNode
---@param Key FBlackboardKeySelector
---@return FVector
function UBTFunctionLibrary:GetBlackboardValueAsVector_Interpreted(NodeOwner, Key) end
---@param NodeOwner UBTNode
---@param Key FBlackboardKeySelector
---@return FVector
...
---@field bRequireGoalActorToBeGrounded boolean
...
---@param KeyName FName
---@return FVector
function UBlackboardComponent:GetValueAsVector_Interpreted(KeyName) end
---@param KeyName FName
---@return FVector
...
---@field ScoreAsDeviationFromDesiredDistance boolean
...
---@field Context TSubclassOf<UEnvQueryContext>
---@field UseQueriersCapsuleShape FAIDataProviderBoolValue
---@field QueriersCapsuleScaleMultiplier FAIDataProviderFloatValue
---@field SubtractCapsuleRadiiFromDestination FAIDataProviderBoolValue
UEnvQueryTest_Trace = {}
