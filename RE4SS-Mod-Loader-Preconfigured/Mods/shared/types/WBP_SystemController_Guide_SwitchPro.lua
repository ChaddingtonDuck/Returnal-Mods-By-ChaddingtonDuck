...
---@field RightStickSlot UNamedSlot
...
UWBP_SystemController_Guide_SwitchPro_C = {}

---@param IsDesignTime boolean
function UWBP_SystemController_Guide_SwitchPro_C:PreConstruct(IsDesignTime) end
---@param EntryPoint int32
function UWBP_SystemController_Guide_SwitchPro_C:ExecuteUbergraph_WBP_SystemController_Guide_SwitchPro(EntryPoint) end
