...
---@param GenerationRadius float
---@param RemovalRadius float
function UNavigationInvokerComponent:UpdateGenerationRadii(GenerationRadius, RemovalRadius) end
---@return float
function UNavigationInvokerComponent:GetRemovalRadius() end
---@return float
function UNavigationInvokerComponent:GetGenerationRadius() end
