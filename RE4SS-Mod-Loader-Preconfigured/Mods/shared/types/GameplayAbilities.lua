...
---@field ReferenceHelper FGameplayTagReferenceHelper
...
---@field IgnoredSourceTags FGameplayTagContainer
...
function UAbilityTask_ApplyRootMotionConstantForce:ApplyRootMotionConstantForce(OwningAbility, TaskInstanceName, WorldDirection, Strength, duration, bIsAdditive, StrengthOverTime, VelocityOnFinishMode, SetVelocityOnFinish, ClampVelocityOnFinish) end
...
function UAbilityTask_PlayMontageAndWait:CreatePlayMontageAndWaitProxy(OwningAbility, TaskInstanceName, MontageToPlay, Rate, StartSection, bStopWhenAbilityEnds, AnimRootMotionTranslationScale) end
...
---@field CancelAbilitiesMatchingTagQuery FGameplayTagQuery
...
---@return boolean
function UGameplayAbility:K2_CanActivateAbility(ActorInfo, RelevantTags) end
