...
---@param InSettings FSourceEffectBitCrusherSettings
function USourceEffectBitCrusherPreset:SetSettings(InSettings) end
...
---@param InSettings FSourceEffectChorusSettings
function USourceEffectChorusPreset:SetSettings(InSettings) end
...
---@param InNewFrequency float
function USynthComponentMonoWaveTable:SetLowPassFilterFrequency(InNewFrequency) end
