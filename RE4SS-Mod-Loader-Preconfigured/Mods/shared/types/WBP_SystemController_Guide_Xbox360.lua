...
---@class UWBP_SystemController_Guide_Xbox360_C : UUserWidget
...
UWBP_SystemController_Guide_Xbox360_C = {}

---@param IsDesignTime boolean
function UWBP_SystemController_Guide_Xbox360_C:PreConstruct(IsDesignTime) end
---@param EntryPoint int32
function UWBP_SystemController_Guide_Xbox360_C:ExecuteUbergraph_WBP_SystemController_Guide_Xbox360(EntryPoint) end
