...
---@class UWBP_SystemController_Preset_A_C : UHMQScreenWidget
...
---@field DPadLeft UWBP_ControllerPresetKey_C
...
---@field SwithcOptions UWBP_ControllerPresetKey_C
...
---@field XBoxOptions UWBP_ControllerPresetKey_C
...
UWBP_SystemController_Preset_A_C = {}

function UWBP_SystemController_Preset_A_C:Construct() end
---@param IsDesignTime boolean
function UWBP_SystemController_Preset_A_C:PreConstruct(IsDesignTime) end
function UWBP_SystemController_Preset_A_C:ControllerSettingsChanged() end
function UWBP_SystemController_Preset_A_C:ReceiveDestroyScreen() end
---@param EntryPoint int32
function UWBP_SystemController_Preset_A_C:ExecuteUbergraph_WBP_SystemController_Preset_A(EntryPoint) end
