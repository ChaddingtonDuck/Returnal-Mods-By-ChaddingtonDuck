...
---@param bIncludeDisal boolean
---@return TArray<FLiveLinkSubjectKey>
function ULiveLinkBlueprintLibrary:GetLiveLinkSubjects(bIncludeDisabledSubject, bIncludeDisal) end
---@param SubjectName FLiveLinkSubjectName
---@return TSubclassOf<ULiveLinkRole>
...
---@field OrientationAxisX ELiveLinkAxis
---@field OrientationAxisY ELiveLinkAxis
---@field OrientationAxisZ ELiveLinkAxis
---@field TranslationAxisX ELiveLinkAxis
---@field TranslationAxisY ELiveLinkAxis
---@field TranslationAxisZ ELiveLinkAxis
