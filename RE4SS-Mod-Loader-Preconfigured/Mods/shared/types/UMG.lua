...
function UCanvasPanelSlot:SetPositionFast(InPosition) end
---@param InPosition FVector2D
...
function UCanvasPanelSlot:SetAnchorsFast(InAnchors) end
---@param InAnchors FAnchors
...
function URichTextBlock:Refresh() end
---@return FText
...
---@return boolean
function UScrollBox:IsScrollBarVisible() end
---@return float
